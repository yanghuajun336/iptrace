...
8. **System Map update**: Update `.specify/memory/system-map.md` with project metadata derived from the constitution:
   - If `.specify/memory/system-map.md` does not exist, copy `.specify/templates/system-map-template.md` to `.specify/memory/system-map.md` first.
